...
insert into user  values ('ctong0', 'Connie Tong', '0043718043', '1 Brickson Park Circle', '1935596015');
insert into user  values ('rkinvig1', 'Robbie Kinvig', '4430701458', '17426 Bellgrove Lane', '1783902001');
insert into user  values ('gcraske2', 'Garvin Craske', '2339702895', '8 Burrows Terrace', '1436620221');
insert into user  values ('mschruy3', 'Moises Schruyers', '9258649087', '5 Lakeland Drive', '5186399426');
insert into user  values ('cwaterl4', 'Curt Waterland', '0636222330', '19 Orin Pass', '1038880536');
insert into user  values ('egeerts5', 'Elwood Geertsen', '7489426634', '2 Chive Street', '7621676435');
insert into user  values ('tivanov6', 'Tabina Ivanchikov', '5380131212', '3429 Norway Maple Way', '9763901450');
insert into user  values ('nbeagan7', 'Natalee Beagan', '4219077677', '0 Jackson Point', '8291479133');
insert into user  values ('xbootyman8', 'Xavier Bootyman', '2144170525', '21 Larry Alley', '8178358688');
insert into user  values ('hfirmager9', 'Hakeem Firmager', '8747665033', '598 Carberry Trail', '2869996969');
...
insert into complaints values(1, 'gcraske2', 10001, 1000, 'Charging more fine than listed for traffic offences by threatening people', 'not viewed', '2021-12-21 16:20:23');
insert into complaints values(2, 'egeerts5', 10001, 1000, 'Charging more fine than listed for traffic offences by threatening people', 'not viewed', '2021-12-22 12:34:23');
insert into complaints values(3, 'nbeagan7', 10002, 1002, "Did not catch a person overspeeding just because he was the son of a minister", 'not viewed', '2021-12-21 16:20:23');
insert into complaints values(4 , 'gcraske2', 10003, 1003, 'Seen riding without helmet', 'not viewed', '2019-03-23 15:20:23');
insert into complaints values(5 , 'xbootyman8', 10004, 1004, 'Not regular in monitoring traffic', 'not viewed', '2021-12-21 16:20:23');
